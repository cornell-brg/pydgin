...
def execute_fmsub_d( s, inst ):
  a, b, c = s.fp[inst.rs1], s.fp[inst.rs2], s.fp[inst.rs3]
  s.fp[ inst.rd ] = lib.f64_mulAdd( a, b, fp_neg(c,64) )
  s.fcsr          = lib.softfloat_exceptionFlags
  lib.softfloat_exceptionFlags = 0
  s.pc += 4
...
def execute_fnmsub_d( s, inst ):
  a, b, c = s.fp[inst.rs1], s.fp[inst.rs2], s.fp[inst.rs3]
  s.fp[ inst.rd ] = lib.f64_mulAdd( fp_neg(a,64), b, c )
  s.fcsr          = lib.softfloat_exceptionFlags
  lib.softfloat_exceptionFlags = 0
  s.pc += 4
...
def execute_fnmadd_d( s, inst ):
  a, b, c = s.fp[inst.rs1], s.fp[inst.rs2], s.fp[inst.rs3]
  s.fp[ inst.rd ] = lib.f64_mulAdd( fp_neg(a,64), b, fp_neg(c,64) )
  s.fcsr          = lib.softfloat_exceptionFlags
  lib.softfloat_exceptionFlags = 0
  s.pc += 4
