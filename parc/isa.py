...
# ['c_ngt_s',  '010001_10000_xxxxx_xxxxx_xxxxx_111111'],
  ...
  # Extensions
  #---------------------------------------------------------------------
  # TASK 1.3: pick the correct encoding
  #  1/0: match 1 or 0
  #  x:   wildcard that matches any bit
  #  _:   delimiter between fields
  # Encoding for the gcd instruction:
  #
...
def execute_gcd( s, inst ):
  # TASK 1.4: implement gcd here
  #  Generic GCD algorithm in Python:
  #  def gcd( a, b ):
  #    while b:
  #      a, b = b, a%b
  #    return a
